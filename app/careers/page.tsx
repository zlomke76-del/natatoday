            ...
            >
              ...
              <label style={consentBoxStyle}>
                ...
                <span>
                  ...
                  my application, interview scheduling, interview reminders, and
                  hiring process updates. Message and data rates may apply. Reply{" "}
                  <strong>STOP</strong> to opt out of SMS or{" "}
                  <strong>HELP</strong> for help. I agree to the{" "}
                  <a href="/terms" target="_blank" style={inlineLinkStyle}>
                    Terms
                  </a>{" "}
                  and acknowledge the{" "}
                  <a href="/privacy" target="_blank" style={inlineLinkStyle}>
                    Privacy Policy
                  </a>
                  .
                </span>
