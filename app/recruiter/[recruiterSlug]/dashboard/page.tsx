    ...
    <main className="shell">
      ...
      <section className="wrap" style={{ padding: "46px 0 90px" }}>
        ...
        <ActionNotice
          ...
          copy="NATA Today will handle posting, candidate intake, screening, routing, and packet preparation before candidates appear on your board."
        />

        <ActionNotice
          show={requestClosed}
          title={`${submittedRole} request closed.`}
          copy="This role has been removed from active hiring. Existing candidates remain archived for future review."
        />
